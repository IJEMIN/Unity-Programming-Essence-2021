...
이 문서는 『레트로의 유니티 게임 프로그래밍 에센스』 개정판의 확인된 오류와 출판사에서 확인 중인 제보를 관리합니다.
...
- 출판사에서 아직 검토 중인 항목은 `위치 및 비고`에 **출판사 확인 중**으로 표시합니다.
...
| 282 | 과정 03의 1<br><br>**비고:** 출판사 확인 중 (종이책, 2025-01-24 등록) | 인스펙터 창에서 Bullet(1) 선택 | 하이어라키 창에서 Bullet(1) 선택 |  |
...
| 583 | 첫째 줄, 임곗값의 영어<br><br>**비고:** 출판사 확인 중 (종이책, 2025-01-11 등록) | Treshold | Threshold |  |
